...
const About = () => {
  ...
  const descAquaq = "I originally joined AquaQ as a kdb+ Graduate developer and in the first two months completed AquaQ’s in house training which consisted of '<span> // kdb+, Linux and Financial training.</span>' I was then offered to move to work on a React.js based front-end project where my team is currently developing a web interface for a major global financial services client, where I actively contribute to the current sprint(s). In this time I have also studied and passed my AWS Certified Cloud Practitioner exam.";
